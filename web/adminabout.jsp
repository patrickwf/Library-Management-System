            ...
            <div id="main">
                <div class="row">
                  <div class="span8">
                        ...
                        <br />
                        <h4>    Holiday，源于我们工作室创始人的英文名，同时也迎
						    合了即将来临的假期。holiday reading创建于2014年
							12月29日，它是致力于为读者提供优质阅读的网上图书
							馆。holiday工作室由五位优秀的人员组成，他们分别
							是负责人Holiday，软件工程师Singlelines，美工设
							计Manax,界面设计Christal、Smallfish。
                       </h4>
					   <br/>
                    ...
                    <div class="span4">
                        <div>
                            <img src="images/logo1.jpg" alt="Company Logo" width="309" /> </div>
                        <br />
						<h4>Company Logo</h4>
						<br/>
