...
<body>
	...
	<div class="container">
		<div id="main">
			<div class="row">
				<div class="span6">
					<span class="error">Library</span> <span class="error_text">万般皆下品，唯有读书高</span><br />
					<span class="error_text">书富如入海，百货皆有。人之精力，不能兼收尽取，但得春所欲求者尔。故愿学者每次作一意求之。</span>
					<span class="error_text"></span> <br />
					<div>
						<img src="content/images/logo_small.png" alt="logo" />
					</div>
					<br />
				</div>
				<div class="span6">
					<img src="content/images/shu.png" alt="da pic" height="481" />
				</div>
			</div>
		</div>
	</div>
