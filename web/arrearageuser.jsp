<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="yznu.holiday.bean.*,java.util.*,yznu.holiday.dao.QueryDao,yznu.holiday.dao.UserDao" %> 
    ...
    <body class="portfolio pngfix">
         <div id="header">
            ...
            <div class="container">
                <h2>欠费用户</h2>
                <div class="search">
                    <form action="AddBlackListServlet">
                        <fieldset>
...
<div class="container">
    ...
    <br/>
                ...
                <table class="table_black1">
                    ...
                    <tbody>
                     <%
              List allUser=(List)request.getAttribute("listArrearage");
      		  ...
      		  %>
                        <tr class="odd">
                            ...
                            <%
                               if(check){
                            %>
                            <td><a href="<%=cancelblacklist%>">取消黑名单</a></td>
                            <%}
                               else{                           
                            %>
                            <td><a href="<%=blacklist%>">添加黑名单</a></td>
                            <%} %>
                        </tr>
                        <%} %>
                        <tr class="even">
